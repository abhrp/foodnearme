...
class RestaurantsRemoteImpl @Inject constructor(private val foodApiFactory: FoodApiFactory, private val venuesMapper: VenuesMapper, private val errorUtil: ErrorUtil): RestaurantsRemote {
    /**
